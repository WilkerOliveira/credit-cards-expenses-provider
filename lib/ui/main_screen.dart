...
import 'package:credit_cards_expenses_provider/ui/credit_card_front.dart';
import 'package:credit_cards_expenses_provider/ui/statement_item_widget.dart';
...
class _MainScreenState extends State<StatefulWidget> {
  ...
  Widget build(BuildContext context) {
    creditCardModel = CreditCardStreamViewModel();
    log("***** _MainScreenState.build *****");
  ...
  //                 return CreditCardFront(creditCard: model.creditCards[index]);
  //               },
          ...
          child: Column(
            children: <Widget>[
              SizedBox(
                ...
                child: new Swiper(
                  itemBuilder: (BuildContext context, int index) {
                    return CreditCardFront(creditCard: list[index]);
                  },
                  onIndexChanged: (int index) {
